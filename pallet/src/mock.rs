...
impl_opaque_keys! {
    pub struct TestSessionKeys {
        pub bankless: super::Pallet<Test>,
    }
}
...
pub fn new_test_ext(authorities: &[(u64, u64)]) -> sp_io::TestExternalities {
    ...
    let session_keys: Vec<_> = authorities
        ...
        .enumerate()
        .map(|(i, (k, _))| (i as u64, i as u64, TestSessionKeys { bankless: k }))
        .collect();
...
pub(crate) fn run_session(n: u64) {
    while System::block_number() < n {
        ...
        Bankless::on_finalize(System::block_number());
        ...
        Bankless::on_initialize(System::block_number());
    }
}
