...
use bankless_bft::{NodeCount, PartialMultisignature, SignatureSet};
use codec::Encode;
...
use bankless_primitives::AuthoritySignature;
use AcceptancePolicy::*;

use crate::crypto::{Signature, SignatureV1};
use crate::justification::{
    backwards_compatible_decode, BanklessJustification, BanklessJustificationV1, JustificationDecoding,
...
fn correctly_decodes_v1() {
    ...
    let just_v1 = BanklessJustificationV1 {
...
fn correctly_decodes_v2() {
    ...
    let just_v2 = BanklessJustification {
        signature: signature_set,
    };
...
fn create_justification_notification_for(block: TBlock) -> JustificationNotification<TBlock> {
    JustificationNotification {
        justification: BanklessJustification {
