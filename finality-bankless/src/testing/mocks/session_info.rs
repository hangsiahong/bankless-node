...
use crate::justification::{BanklessJustification, SessionInfo, SessionInfoProvider, Verifier};
...
impl Verifier<TBlock> for VerifierWrapper {
    fn verify(&self, _justification: &BanklessJustification, _hash: THash) -> bool {
