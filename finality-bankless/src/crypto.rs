use bankless_bft::{
    KeyBox as BanklessKeyBox, MultiKeychain, NodeCount, NodeIndex, PartialMultisignature, SignatureSet,
};
use bankless_primitives::{AuthorityId, AuthoritySignature, KEY_TYPE};
...
/// KeyBox combines an AuthorityPen and AuthorityVerifier into one object implementing the BanklessBFT
/// MultiKeychain trait.
#[derive(Clone)]
pub struct KeyBox {
    id: NodeIndex,
...
impl BanklessKeyBox for KeyBox {
